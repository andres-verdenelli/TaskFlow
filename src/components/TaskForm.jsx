...
//falta evitar enviar el formulario vacio
export function TaskForm({ setTaskFormOpen }) {
  ...
  const [taskListId, setTaskListId] = useState(currentView.listId)
  ...
  useEffect(() => {
    ...
    const inputElement = document.getElementById('task-name-input')
